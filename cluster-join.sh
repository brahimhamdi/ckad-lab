...
scp -i .vagrant/machines/kube-node1/virtualbox/private_key join-command.sh vagrant@192.168.56.11:/tmp/
scp -i .vagrant/machines/kube-node2/virtualbox/private_key join-command.sh vagrant@192.168.56.12:/tmp/
